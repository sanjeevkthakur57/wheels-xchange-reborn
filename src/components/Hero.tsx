          ...
          <div className="pt-10 mx-auto max-w-7xl px-4 sm:pt-12 sm:px-6 md:pt-16 lg:pt-20 lg:px-8 xl:pt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block">Buy and sell cars</span>
                <span className="block text-blue-600">
                  with confidence
                </span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Find your perfect car at WheelsXchange - your trusted marketplace for buying and selling quality pre-owned vehicles. Get the best deals with our transparent pricing and thorough inspection process.
              </p>
